...
it('converts B to H correctly', () => {
  expect(NoteUtils.convertBtoH('')).toBe('');
  expect(NoteUtils.convertBtoH('G3-C3')).toBe('G3-C3');
...
it('converts H to B correctly', () => {
  expect(NoteUtils.convertHtoB('')).toBe('');
  expect(NoteUtils.convertHtoB('G3-C3')).toBe('G3-C3');
